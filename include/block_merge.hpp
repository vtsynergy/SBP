...
#include "partition/sparse/dict_transpose_matrix.hpp"
...
/// Proposes a merge for current_block based on the current partition state, using sparse intermediate structures
ProposalEvaluation propose_merge_sparse(int current_block, Partition &partition, std::vector<int> &block_partition);
...
double compute_delta_entropy_sparse(int current_block, int proposal, Partition &partition,
