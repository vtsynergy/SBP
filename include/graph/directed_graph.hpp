 ...
 * Stores a Graph.
 */
#ifndef SBP_DIRECTED_GRAPH_HPP
#define SBP_DIRECTED_GRAPH_HPP
...
public:
    explicit DirectedGraph(long num_vertices) {
    ...
    DirectedGraph(NeighborList &out_neighbors, NeighborList &in_neighbors, long num_vertices, long num_edges,
...
//    void assign(long v, long b) { this->_assignment[v] = b; }
    ...
    [[nodiscard]] const NeighborList &in_neighbors() const override { return this->_in_neighbors; }
    /// Returns a const reference to the in neighbors of vertex `v`
    [[nodiscard]] const std::vector<long> &in_neighbors(long v) const override { return this->_in_neighbors[v]; }
...
//    [[nodiscard]] long num_islands() const override;
...
//    void degree_product_sort() override;
//private:
