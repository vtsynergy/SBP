...
VertexMove propose_gibbs_move(Partition &partition, int vertex, std::vector<Matrix2Column> &out_neighbors,
                            std::vector<Matrix2Column> &in_neighbors);
...
Partition &asynchronous_gibbs(Partition &partition, int num_vertices, int num_edges,
                              std::vector<Matrix2Column> &out_neighbors, std::vector<Matrix2Column> &in_neighbors,
                              PartitionTriplet &partitions);
