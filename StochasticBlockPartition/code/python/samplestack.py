...
class SampleStack(object):
    ...
    def unstack(self, args: Namespace, subgraph_partition: Partition = None,
        ...
        return combined_subgraph, subgraph_partition, sample, evaluation
    # End of unstack()

    def extrapolate_sample_partition(self, subgraph_partition: Partition, vertex_mapping: Dict[int, int],
                                     args: Namespace, evaluation: Evaluation) -> Tuple[Graph, Partition, Evaluation]:
    ...
    def combine_partition_with_sample(self, combined_partition: Partition, sample_partition: Partition,
                                      previous_sample: Sample, next_sample: Sample,
                                      args: Namespace) -> Tuple[Partition, Graph, Sample]:
        """Combine the partition with the sample.
        """
        print("Adding sample partitioning results to previous partitioning results.")
        # Combine vertice IDs
        vertices = next_sample.state.sample_idx
