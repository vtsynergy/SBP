...
void DirectedGraph::add_edge(long from, long to) {
...
std::vector<long> DirectedGraph::degrees() const {
...
//double DirectedGraph::modularity(const std::vector<long> &assignment) const {
...
std::vector<long> DirectedGraph::neighbors(long vertex) const {
...
void DirectedGraph::sort_vertices() {
...
//void DirectedGraph::degree_product_sort() {
...
//long DirectedGraph::num_islands() const {
//    std::vector<long> vertex_degrees = this->degrees();
//    long num_islands = 0;
...
//std::vector<std::pair<std::pair<long, long>, long>> DirectedGraph::sorted_edge_list() const {
//    std::vector<long> vertex_degrees = this->degrees();
