...
void Graph::sort_vertices() {
    ...
    std::vector<long> indices = utils::range<long>(0, this->_num_vertices);
    std::nth_element(std::execution::par_unseq, indices.data(), indices.data() + long(0.075 * this->_num_vertices),
    ...
    for (long index = 0; index < this->_num_vertices; ++index) {
